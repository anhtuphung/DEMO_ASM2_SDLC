        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="general-pages">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="pages/samples/blank-page.html"> Student </a></li>
                    <li class="nav-item"> <a class="nav-link" href="pages/samples/login.html"> Teacher </a></li>
