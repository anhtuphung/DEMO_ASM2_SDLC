...
function handleEdit(){
    if(isset($_POST['btnSave'])){
        ...
        if(empty($department_id)){
            $_SESSION['error_update_course']['department_id'] = 'Enter name of department_id, please';
        } else{
...
function handleAdd(){
    ...
    if(isset($_POST['btnSave'])){
        ...
        if(empty($department_id)){
            $_SESSION['error_add_course']['department_id'] = 'Enter name of department_id, please';
        } else{
